package com.banfftech.cdsbfdemo.ofbizutil;
...
import com.banfftech.cdsbfdemo.ofbizutil.collection.MapComparator;
...
public final class UtilMisc {
    ...
    public static <V> void makeMapSerializable(Map<String, V> map) {
        ...
        for (Map.Entry<String, V> mapEntry: map.entrySet()) {
            ...
            if (entryValue != null && !(entryValue instanceof Serializable)) {
                ...
                logger.info("Found Map value that is not Serializable: " + mapEntry.getKey() + "=" + mapEntry.getValue());
            }
        }
    ...
    public static String collectionToString(Collection<? extends Object> values, String delimiter) {
        ...
        for (Object val : values) {
            ...
            out.append(val.toString()).append(delimiter);
        }
        return out.toString();
    }
    ...
    public static Locale parseLocale(String localeString) {
        ...
        if (localeString.length() == 2) {
            ...
            logger.info("Do not know what to do with the localeString [" + localeString + "], should be length 2, 5, or greater than 6, returning null");
        }
